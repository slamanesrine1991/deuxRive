...
class DrawerForm extends React.Component {
  ...
  handleChange = event => {
    ...
    this.setState({ validEmail: event.target.value });
  };
    ...
    return (
      <div>
        <Button type="primary" onClick={this.showDrawer}>
          <Icon type="plus" /> Ajouter un project
        </Button>
        <Drawer
        ...
        >
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item label="Titre de Project">
                  {getFieldDecorator("title", {
                    rules: [
                      { required: true, message: "ce champ est obliagtoir" }
                    ]
                  })(
                    <span>
                      <Input
              ...
              <Col span={12}>
                <Form.Item label="Email visible">
                  {getFieldDecorator("validEmail", {
                    ...
                    >
                      <option setFieldsValue="true"> non</option>
                      <option setFieldsValue="false">oui </option>
                    </select>
                  )}
                </Form.Item>
              </Col>
